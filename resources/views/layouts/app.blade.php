...
<body>
    ...
    <svg width="0" height="0">
        <defs>
          <clipPath id="footerClipPath" clipPathUnits="objectBoundingBox">
            <path d="M0.618 0.243C0.03 0.381 0.029 0.04 0.019 0C0.019 0 -0.147 0.984 0.179 1.541C0.6 2.261 1.43 1.456 1.105 2.563C1.083 2.637 1.183 2.463 1.253 2.409C1.454 2.138 1.548 1.676 1.508 1.227C1.46 0.704 1.294 0.09 0.618 0.243Z" />
          </clipPath>
        </defs>
      </svg>
    ...
    <footer>
       <div class="footer">
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-lg-6 col-12 d-flex justifyt-content-between  align-items-start flex-lg-column ">
            ...
            <div class="d-flex gap-2">
                <img src="{{asset('assets/images/attributes/logo.svg')}}" alt=""><p class="footer-copywrite"> &#64; kemea {{now()->format('Y')}}</p>
            </div>
        </div>
