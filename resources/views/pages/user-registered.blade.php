    ...
    <div class="container">
        <section class="background-image margin-top-20">
            <div class="content">
                ...
                <div class="fw-300 fs-20 text-light text-center margin-top-30 p-3">Discover our exclusive selection of
                    real
        ...
        <section class="personalized margin-top-100">
            <div class="row ">
                <div class="col-md-6 col-12 margin-top-57 margin-bottom-30">
        ...
        <section class="margin-top-100">
            ...
            <div class="margin-top-30">
                ...
                <div class="d-flex gap-3 justify-content-center margin-top-24">
                    <div class="">
                        <a href="#" class="btn btn-outline-dark rounded-pill padding-y-16 padding-x-56">Iphone</a>
                    </div>
                    <div class="">
                        <a href="#"
