        ...
        <div class="agency-card">
            <div class="row  h-100 g-3 p-4">
                ...
                <div class="middle col-lg-2 col-md-6 col-12">
                    <img src="{{ asset('assets/companyLogo.png') }}" class="agency-logo" alt="">
                </div>
                <div
                ...
                <div
                    ...
                    <div class="agency-contact margin-right-40">
                        ...
                        <div class="agency-contact_links">
                            <a href=""><img src="{{ asset('assets/images/attributes/website-out.svg') }}"
                                    alt=""> <span>See their website</span></a>
                            <a href=""><img src="{{ asset('assets/images/attributes/phone.svg') }}"
                                    alt=""> <span>Show phone number</span></a>
                        </div>
