<x-app>
    ...
    <nav  class="sticky-top w-100 margin-y-20 mx-0 padding-y-10  postion-relative filter-nav"
        ...
        <div class="container filter-bar" style="background:#fff ">
            ...
            <div class="toggle-button" x-data="{ type: 'rent' }">
                <div :class="type === 'buy' ? 'active' : ''">
                    <input type="radio" value="buy" id="buy" x-model="type" name="filter[type]">
                    <label for="buy">Buy</label>
                </div>
                <div :class="type === 'rent' ? 'active' : ''">
                    <input type="radio" value="rent" id="rent" x-model="type" name="filter[type]">
