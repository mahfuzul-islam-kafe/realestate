<x-app>
    ...
    <div class="container">
        <section class="row ">
            <div class="col-md-7 ">
                <div class="margin-left-100" style="margin-top: 130px">
                    <div class="fw-600 fs-57">
                        Are you owners and <br> want to sell your home ?
                    </div>
            ...
            <div class="col-md-5">
                <img src="{{ asset('assets/images/sale-out.png') }}" alt=""
                ...
                <div class="margin-left-100" style="margin-top: 130px">
                    <div class="step-form">
                        ...
                        <div class="form-group my-4">
                            <label for="total_surface" class="form-label">What is the desired net selling price?*</label>
                            <div class="input-group">
